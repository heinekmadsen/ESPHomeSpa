...
namespace esphome
{
  namespace spa_reader
  {
    ...
    void SpaReader::set_temp_sensor(sensor::Sensor *temp_sensor)
    {
      this->temp_sensor_ = temp_sensor;
    }
    void SpaReader::set_circ_binary_sensor(binary_sensor::BinarySensor *circ_binary_sensor)
    {
    ...
    void SpaReader::decodeState()
    {
      ...
      if (target_temp_sensor_ != nullptr)
        target_temp_sensor_->publish_state(d);
      ...
      case 0:
        ...
        SpaState.restmode = 0;
        if (restmode_sensor_ != nullptr)
          restmode_sensor_->publish_state(0);
        break;
      ...
      case 1:
        ...
        SpaState.restmode = 1;
        if (restmode_sensor_ != nullptr)
          restmode_sensor_->publish_state(1);
        break;
      }
      ...
      if (d == 0)
      {
        ...
        if (heater_sensor_ != nullptr)
          heater_sensor_->publish_state(0);
        SpaState.heater = 0;
      }
      else if (d == 1 || d == 2)
      {
        ...
        if (heater_sensor_ != nullptr)
          heater_sensor_->publish_state(1);
        SpaState.heater = 1;
      }
      ...
      if (d == 0)
      {
        ...
        if (highrange_sensor_ != nullptr)
          highrange_sensor_->publish_state(0);
      ...
      else if (d == 1)
      {
        ...
        if (highrange_sensor_ != nullptr)
          highrange_sensor_->publish_state(1);
      ...
      if (bitRead(this->Q_in[16], 1) == 1)
      {
        ...
        if (jet1_sensor_ != nullptr)
          jet1_sensor_->publish_state(1);
        SpaState.jet1 = 1;
      }
      else
      {
      ...
      if (bitRead(this->Q_in[16], 3) == 1)
      {
        ...
        if (jet2_sensor_ != nullptr)
          jet2_sensor_->publish_state(1);
        SpaState.jet2 = 1;
      }
      else
      {
      ...
      if (bitRead(this->Q_in[18], 1) == 1)
      {
        ...
        SpaState.circ = 1;
        if (circ_binary_sensor_ != nullptr)
        {
          circ_binary_sensor_->publish_state(1);
        }
      }
      else
      ...
      if (circ_binary_sensor_ != nullptr)
      {
        circ_binary_sensor_->publish_state(0);
      }
      ...
      if (bitRead(this->Q_in[18], 2) == 1)
      {
        ...
        if (blower_sensor_ != nullptr)
          blower_sensor_->publish_state(1);
      }
      else
      {
        ...
        SpaState.blower = 0;
        if (blower_sensor_ != nullptr)
          blower_sensor_->publish_state(0);
      }
      // 19:Flags Byte 14
